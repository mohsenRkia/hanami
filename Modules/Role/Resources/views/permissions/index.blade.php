    ...
    <div class="col-lg-12">
        <div class="form-box">
            <div class="form-title-wrap">
                <h3 class="title">لیست دسترسی ها</h3>
                <p class="font-size-14"><i class="la la-heart mr-2 text-color-6"></i><a href="{{route('panel.roles.permissions.create')}}">افزودن دسترسی جدید</a></p>
            </div>
                ...
                <div class="table-form table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th scope="col">نام انگلیسی دسترسی</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-content">
                                        <h3 class="title">{{$permission->name_fa}}</h3>
                                    </div>
                                </td>
                                <td>
                                    <div class="table-content">
                                ...
                                <td>
                                    <div class="table-content">
                                        <h3 class="title">{{$permission->guard_name}}</h3>
                                    </div>
                                </td>
