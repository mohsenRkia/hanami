                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control " value="{{$area->name_fa}}" name="name_fa" id="name_fa">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control " value="{{$area->name_en}}" name="name_en" id="name_en">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
